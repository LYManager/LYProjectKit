...
- (void)setupDefaultValue{
    ...
    self.boxNormalBorderColor = [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:0.25];
    self.boxHighlightBorderColor = [UIColor grayColor];
    self.boxCornerRadius = 4;
    self.boxBorderWidth = 0.5f;
    self.boxBGColor = [UIColor whiteColor];
    self.boxTextColor = [UIColor redColor];
